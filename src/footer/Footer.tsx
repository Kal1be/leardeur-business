...
function Footer() {
  return (
    <div className="bg-slate-800 lg:px-12 px-4 mt-10  text-gray-300 py-8">
        <div className="md:flex justify-between">
        <div className="my-2">
            <h2 className="font-bold text-2xl md:text-3xl text-slate-200 my-1" id="titl"><FontAwesomeIcon icon={faCouch} className="me-2"/>Leadeur Business</h2>
