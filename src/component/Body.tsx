  ...
  return (
    <div className="lg:flex items-center md:px-8 px-2 md:pt-16 pt-10">
        <div className="md:w-[80%] pe-3">
            ...
            <h2 className="text-3xl font-bold pt-2 text-gray-600 ">Qui somme nous?</h2>
    ...
    <p className="px-1 pb-10 font-bold">prix: 200000FCFa</p>
        ...
        <div className="shadow-xl my-4 md:my-0 lg:mx-2 w-full">
            <img src="/leardeur-business/a7.png" alt="" className="h-[30vh] md:w-[60vw] w-full"/>
